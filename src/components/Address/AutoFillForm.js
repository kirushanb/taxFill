...
const AutoFillForm = ({
  ...
  useEffect(() => {
    ...
    if (addressComingFrom) {
      if (formRef.current) {
        formRef.current.setFieldValue(
          "companyAddress",
          addressComingFrom.companyAddress
        );
        formRef.current.setFieldValue("zipCode", addressComingFrom.zipCode);
        formRef.current.setFieldValue("city", addressComingFrom.city);
        formRef.current.setFieldValue(
          "stateOfAddress",
